...
import DatabaseAdapter, {
  ...
  type CheckApplicationSecretOptions,
  type Collection,
  ...
  type Episode,
  type File,
  type FindAccessTokenByIdOptions,
  type FindAccessTokenOptions,
  type FindApplicationByIdOptions,
  type FindAuthorizationCodeOptions,
  type FindCollectionByIdOptions,
  type FindEpisodeByIdOptions,
  type FindFileByIdOptions,
  type FindProviderProfileByIdOptions,
  type FindRefreshTokenByIdOptions,
  type FindRefreshTokenOptions,
  ...
  type RemoveAccessTokenByIdsOptions,
  type RemoveAuthorizationCodeOptions,
  type RemoveRefreshTokenByIdsOptions,
  type SaveAccessTokenOptions,
  type SaveAuthorizationCodeOptions,
  type SaveRefreshTokenOptions,
  type Season,
  type Source,
  type TokenReference,
