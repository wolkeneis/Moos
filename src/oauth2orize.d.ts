...
export namespace exchange {
  ...
  function password(
    options: Options,
    issue: (client: any, username: string, password: string, scope: string[], body: any, authInfo: any, issued: ExchangeDoneFunction) => void
  ): MiddlewareFunction;
  // arity == 6; issue(client, username, passwd, scope, req.body, issued);
  function password(
    options: Options,
    issue: (client: any, username: string, password: string, scope: string[], body: any, issued: ExchangeDoneFunction) => void
  ): MiddlewareFunction;
  ...
  function refreshToken(
    options: Options,
    issue: (client: any, refreshToken: string, scope: string[], body: any, authInfo: any, issued: ExchangeDoneFunction) => void
  ): MiddlewareFunction;
